...
const Account = () => {
    return (
        <div>
            ...
            <div className='md:flex py-[3rem] w-full gap-6 justify-center'>
                <section className='md:w-[45%] w-full flex flex-col gap-[1.6rem]'>
                    ...
                    <Input title={'Username or email address'} placeholder="Enter your username or email" />
                    ...
                    <div className='flex items-center text-[.9em] md:text-[1.1em] tracking-wider font-medium gap-4'>
                        <input className='size-6 md:size-8' type="checkbox" id="remember" /> 
