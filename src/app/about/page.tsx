...
// Define prop types for CategoriesItem component
...
// Define prop types for PostCard component
...
const PostCard: React.FC<PostCardProps> = ({ src, date = '13 Oct 2022', title }) => (
  <div className="flex gap-4 items-center">
    <div>
      <Image src={src} width={100} height={100} className="md:size-full object-cover overflow-hidden rounded-lg" alt={title} />
    </div>
    <div>
...
// Define prop types for BlogCard component
...
const BlogCard: React.FC<BlogCardProps> = ({
  ...
  <article className="flex flex-col gap-4 md:gap-6">
    <div>
      <Image src={src} width={500} height={300} className="object-cover size-full" alt={title} />
    </div>
    <div className="flex flex-wrap gap-4 md:gap-6 items-center ">
      <div className="flex text-[#9F9F9F] tracking-wide text-[.8em] font-medium md:text-xl items-center gap-2 md:gap-4">
        <FaUser size="1.5rem" color="#9F9F9F" />
        <span>Admin</span>
      </div>
      <div className="flex text-[#9F9F9F] tracking-wide text-[.8em] font-medium md:text-xl items-center gap-2 md:gap-4">
        <SlCalender size="1.5rem" color="#9F9F9F" />
        <span>14 Oct 2022</span>
      </div>
      <div className="flex text-[#9F9F9F] tracking-wide text-[.8em] font-medium md:text-xl items-center gap-2 md:gap-4">
        <FaTag size="1.5rem" color="#9F9F9F" />
        <span>{type}</span>
      </div>
    </div>
    ...
    <div className="py-[3em] md:py-0">
      ...
      <main className="md:flex cp py-[2rem] md:py-[4rem] justify-between gap-4 md:gap-8">
        <section className="md:w-[70%] flex flex-col gap-[2rem] md:gap-[3rem]">
          <BlogCard src={'/images/Article1.png'} title={'Going All in one with Millenial Design.'} type="Design" />
          <BlogCard src={'/images/Article2.png'} title={'Exploring New ways of Decorating.'} type="HandMade" />
          <BlogCard src={'/images/Article2.png'} title={'Hand Made pieces that took to made.'} type="Wood" />
        </section>
